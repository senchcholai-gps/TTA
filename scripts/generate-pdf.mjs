...
// Logo positioned top-right with generous breathing room (increased size by ~22%)
const LOGO_AREA_X = 296
const LOGO_AREA_W = PAGE_W - LOGO_AREA_X - MARGIN - 4
const LOGO_AREA_H = HEADER_H - 24  // vertical space available
const LOGO_AREA_Y = 12

const LOGO_MAX_W = LOGO_AREA_W        // max width  ≈ 243pt
const LOGO_MAX_H = LOGO_AREA_H - 10  // max height ≈ 138pt
...
if (fs.existsSync(LOGO_WHITE)) {
  ...
  const logoY = LOGO_AREA_Y + (LOGO_AREA_H - fitH) / 2 + 4
